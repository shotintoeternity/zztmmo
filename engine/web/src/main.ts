...
// The custom Perfect DOS VGA 437 web font maps CP437 index bytes 0..255 directly
// to Unicode U+0000..U+00FF. We draw any CP437 character ch by passing its byte
// value directly using String.fromCharCode(ch).
