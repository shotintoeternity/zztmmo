// Copied from shotintoeternity/zztmmo (engine/web/src/sidebar.ts, MIT); see NOTICE.md.
// The chat and players rows are replaced by this client's V (view) key.
...
export function drawWatchSidebar(write: WriteText, watchers: number, replaying = false, channelLabel = "") {
  ...
  if (channelLabel) {
    write(64, 5, 0x1e, channelLabel.padEnd(15, " "));
    write(62, 19, 0x70, " N ");
    write(65, 19, 0x1f, " Next");
  }
